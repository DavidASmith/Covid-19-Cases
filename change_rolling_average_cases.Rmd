...
This map shows, for each local authority, the _change_ in rolling mean of daily lab confirmed cases over seven days from **`r most_recent_included_date - days(7)`** to **`r most_recent_included_date`**.
...
tm_basemap("CartoDB.Positron") +
  ...
  tm_polygons(col = "rolling_mean_change", 
              ...
              popup.vars = c("Change in Rolling Mean Cases" = "rolling_mean_change"), 
              palette = "-RdYlGn")
